...
public extension BaseUITestCase {
    ...
    ///   - timeout: The time to wait for the button element. Default is 3 seconds.
    ...
    /// - Parameters:
    ///   - buttonId: The identifier for the alert button to tap. Default is "Okay".
    ///   - timeout: The time to wait for the alert button element. Default is 3 seconds.
    func tapAlertButton(buttonId: String = "Okay", timeout: TimeInterval = 3, file: StaticString = #filePath, line: UInt = #line) {
